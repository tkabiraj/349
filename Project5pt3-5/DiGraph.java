...
public class DiGraph {
   ...
   private static VertexInfo[] BFS(int s) {
      
   }

   public static isTherePath(int from, int to) {

   }

   public static lengthOfPath(int from, int to) {

   }

   public static printPath(int from, into to) {
